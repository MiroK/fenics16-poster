...
\end{minted}
\end{tcolorbox}
\textbf{$\vartriangle$ Code}: Probe two locations defined by the array.
%\end{minipage}
...
creates a pull request. A tailored Anaconda build of a recent FEniCS version is
  used in a MiniConda environment and tests start within minutes. 
