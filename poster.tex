...
on travis-ci.org whenever there is a new commit to origin/master, or if someone 
creates a pull request. A tailored Anaconda FEniCS version is used in a MiniConda 
...
%\begin{figure}
\begin{center}
  \fbox{\includegraphics[height=6cm]{./graphics/travislogo}}\\
  \vspace{1cm}
  \fbox{\includegraphics[height=6cm]{./graphics/anacondalogo}}
\end{center}
%\end{figure}
%
\end{minipage}
