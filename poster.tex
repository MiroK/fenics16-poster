...
\textbf{$\triangleright$ Table}: CPU cost of action of \clm interpolator vs.
$L^2$ projector. 
%
\footnotesize
\end{minipage}};
...
some interesting part of the simulated geometry. The slices may be stored as 
VTK files and viewed, e.g., in Paraview.
}
\end{minipage}
\hfill
\begin{minipage}{0.4\textwidth}
...
requests. A tailored Anaconda build of a recent Fenics version is then used in 
a MiniConda environment and tests start within minutes.
